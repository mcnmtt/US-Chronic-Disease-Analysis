...
H₀ (ipotesi nulla): la media globale di prevalenza del diabete è uguale per maschi e femmine

H_1 : le medie globali sono diverse
...
df_filtered <- df %>%   
  filter(topic %in% c("Diabetes"))

diab_gender <- df_filtered %>%                   
  filter(questionid == "DIA1_1",
